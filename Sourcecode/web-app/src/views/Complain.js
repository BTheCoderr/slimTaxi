...
export default function Complain() {
    ...
    const columns = [
        { title: t('createdAt'), field: 'createdAt', editable: 'never', defaultSort: 'desc', 
          render: rowData => formatDateTime(rowData.complainDate),
          exportTransformer: rowData => formatDateTime(rowData.complainDate)
        },
        ...
        { title: t('processDate'), field: 'processDate', editable: 'never', 
          render: rowData => formatDateTime(rowData.processDate),
          exportTransformer: rowData => formatDateTime(rowData.processDate)
        },
